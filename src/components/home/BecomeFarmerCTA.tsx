        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="text-primary-foreground space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 text-sm font-medium">
              ...
              Join Verified Farmers
            </div>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight">List Your Fresh Produce on AgroTrust</h2>
            <p className="text-lg text-primary-foreground/90">
              Reach buyers across Nigeria. Get verified, list your produce, and connect directly with customers.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-foreground/80">Connect with buyers directly</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-primary-foreground/80">Reach more customers online</p>
                </div>
              </div>
            </div>
            <div className="flex flex-wrap gap-3 pt-2">
              <Button size="lg" className="bg-white text-primary hover:bg-white/90 font-semibold" asChild>
                <Link to="/farmer/onboarding"><BadgeCheck className="h-5 w-5 mr-2" />Become a Verified Farmer</Link>
              </Button>

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Connecting verified Nigerian farmers directly to buyers. Fresh produce, fair prices, no middlemen.
            </p>
          </div>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link to="/farmer/onboarding" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-1.5">
                <BadgeCheck className="h-3.5 w-3.5 text-primary" />Become a Verified Farmer
              </Link>

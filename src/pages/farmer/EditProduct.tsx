          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {currentImageUrl && !productImage && <img src={currentImageUrl} alt="Current" className="h-32 w-32 object-cover rounded-lg" />}
